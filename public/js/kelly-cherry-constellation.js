// KELLY CHERRY CONSTELLATION - OPTIMIZED FOR ANDROID 11
// Minimal, functional, circular, no unnecessary features
...
// Osa Mayor coordinates (normalized)
const URSA_MAJOR = [
    { x: 0.2, y: 0.2, gem: 'JADE' },      // Dubhe
    { x: 0.35, y: 0.25, gem: 'RUBY' },    // Merak
    { x: 0.5, y: 0.3, gem: 'SAPPHIRE' },  // Phad
    { x: 0.65, y: 0.28, gem: 'EMERALD' }, // Megrez
    { x: 0.75, y: 0.35, gem: 'AMBER' },   // Alioth
    { x: 0.85, y: 0.4, gem: 'DIAMOND' },  // Mizar
    { x: 0.9, y: 0.5, gem: 'JADE' }       // Alkaid
];
...
class ConstellationSystem {
    ...
    animate() {
        ...
        // Distant stars (background noise)
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        window.constellation = new ConstellationSystem('particles');
    });
} else {
    window.constellation = new ConstellationSystem('particles');
}

console.log('🍒 Cherry Constellation System Ready');
